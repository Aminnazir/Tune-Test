...
!function (e) {
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net"], function (t) {
        ...
        return t = t || window, (s = s || ("undefined" != typeof window ? require("jquery") : require("jquery")(t))).fn.dataTable || require("datatables.net")(t, s), e(s, t, t.document)
    } : e(jQuery, window, document)
}(function (i, o, j, b) {
    "use strict";
    var _, S, n, a, r, l, h, t, d, c, p, u, f, g, m, w, v, P, y, C, O, x, N, A, D, B = i.fn.dataTable;

    function T(t, s, e, a, i) {
        var n, o = this;
        if (void 0 === i && (i = null), !S || !S.versionCheck || !S.versionCheck("1.10.0")) throw new Error("SearchPane requires DataTables 1.10 or newer");
        if (S.select) return t = new S.Api(t), this.classes = _.extend(!0, {}, T.classes), this.c = _.extend(!0, {}, T.defaults, s, i), s && s.hideCount && s.viewCount === b && (this.c.viewCount = !this.c.hideCount), s = t.columns().eq(0).toArray().length, this.s = {
            colExists: e < s,
            colOpts: b,
    ...
    return T.prototype.addRow = function (t, s, e, a, i, n, o) {
        ...
        this.s.dtPane && (this.s.dtPane.off("select.dtsp").on("select.dtsp", function () {
            ...
            }) : d.dom.topRow.off("click.dtsp"), d.s.dt.state.save()
        ...
        var a = this, t = S.Scroller, s = this.s.dt.settings()[0].oLanguage;
        ...
        this.s.scrollTop = _(this.s.dtPane.table().node()).parent()[0].scrollTop, this.s.dt.page.info().serverSide && !this.s.updating ? this.s.serverSelecting || (this.s.serverSelect = this.s.dtPane.rows({selected: !0}).data().toArray(), this.s.dt.draw(!1)) : t && this._makeSelection()
    }, T.prototype._addOption = function (t, s, e, a, i, n) {
        if (Array.isArray(t) || t instanceof S.Api) {
            if (t instanceof S.Api && (t = t.toArray(), s = s.toArray()), t.length !== s.length) throw new Error("display and filter not the same length");
        ...
        S.select.init(this.s.dtPane), (this.s.colOpts.options || this.s.customPaneSettings && this.s.customPaneSettings.options) && this._getComparisonRows(), this.s.dtPane.draw(), this.s.dtPane.table().node().parentNode.scrollTop = this.s.scrollTop, this.adjustTopRow(), this.setListeners(), this.s.listSet = !0;
        ...
        var s = this.s.dt.i18n("searchPanes.count", this.c.i18n.count),
            e = this.s.dt.i18n("searchPanes.countFiltered", this.c.i18n.countFiltered);
        return (this.s.filteringActive ? e : s).replace(/{total}/g, t.total).replace(/{shown}/g, t.shown)
    }, C = R, M.prototype.clearSelections = function () {
        ...
        for (var s = 0, e = this.s.panes; s < e.length; s++) e[s].dom.collapseButton.on("click.dtsps", function () {
        ...
        var a = this.s.dt.state.loaded(),
            n = (!this.s.stateRead && a && this.s.dt.page(a.start / this.s.dt.page.len()).draw("page"), this.s.stateRead = !0, this._checkMessage(), i.on("preDraw.dtsps", function () {
                ...
                if (s === c) {
                    ...
                    0 < a && (a !== d.s.filterCount ? (e.start = 0, d.s.page = 0) : e.start = d.s.page * d.s.dt.page.len(), d.s.dt.page(d.s.page), d.s.filterCount = a), 0 < d.s.selectionList.length && (e.searchPanesLast = d.s.dt.column(d.s.selectionList[d.s.selectionList.length - 1].column).dataSrc())
                }
        ...
        if (this.s.updating = !0, this.s.dt.page.info().serverSide) {
            ...
            this.clearSelections(), this.s.dt.draw(), this.s.dt.rows().toArray()[0].length > this.s.dt.rows({search: "applied"}).toArray()[0].length && (a = !0), this.s.selectionList = e;
            ...
            for (var o = 0, r = this.s.selectionList; o < r.length; o++) {
                ...
                if (h.s.dtPane) {
                    ...
                    if (h.s.selections = l.rows, 0 !== l.rows.length) {
                        this.s.dt.draw();
                        for (var y = 0, b = 0, _ = 0, S = 0, C = this.s.panes; S < C.length; S++) (O = C[S]).s.dtPane && b < (y += O.getPaneCount()) && (_++, b = y);
        ...
        this.s.updating = !1
    }, A = k, S = (_ = i).fn.dataTable, y = (P = i).fn.dataTable,(D = (m = p = h = i).fn.dataTable).SearchPanes = O,B.SearchPanes = O,D.SearchPanesST = A,B.SearchPanesST = A,D.SearchPane = n,B.SearchPane = n,D.SearchPaneViewTotal = u,B.SearchPaneViewTotal = u,D.SearchPaneCascade = w,B.SearchPaneCascade = w,D.SearchPaneCascadeViewTotal = C,B.SearchPaneCascadeViewTotal = C,(t = i.fn.dataTable.Api.register)("searchPanes()", function () {
        return this
