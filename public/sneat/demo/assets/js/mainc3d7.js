...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")), function () {
    ...
    document.getElementById("layout-menu") && function (e, t) {
        ...
        e.onmouseenter = function () {
            ...
            document.querySelector(".layout-menu-toggle").classList.remove("d-block"), clearTimeout(o)
        }
    ...
    })), window.Helpers.isLightStyle() ? (o && (o.querySelector("i").classList.add("bx-moon"), new bootstrap.Tooltip(o, {
        title: "Dark mode",
        fallbackPlacements: ["bottom"]
    })), s("light")) : (o && (o.querySelector("i").classList.add("bx-sun"), new bootstrap.Tooltip(o, {
        title: "Light mode",
        fallbackPlacements: ["bottom"]
    })), s("dark")));
    let n = document.documentElement.getAttribute("lang"), a = document.getElementsByClassName("dropdown-language");
    if (null !== n && a.length) {
        let e = document.querySelector("a[data-language=" + n + "]"), t = e.childNodes[1].className, o = "fs-",
    ...
    var e = $(".search-toggler"), t = $(".search-input-wrapper"), o = $(".search-input"), s = $(".content-backdrop");
    if (e.length && e.on("click", (function () {
        t.length && (t.toggleClass("d-none"), o.focus())
    })), $(document).on("keydown", (function (e) {
        let s = e.ctrlKey, n = 191 === e.which;
        ...
        if ($("#layout-menu").hasClass("menu-horizontal")) a = "search-horizontal.json";
        var l, i = $.ajax({url: assetsPath + "json/" + a, dataType: "json", async: !1}).responseJSON;
        o.each((function () {
            var e = $(this);
            o.typeahead({
                hint: !1,
                ...
                templates: {
                    ...
                    suggestion: function ({url: e, icon: t, name: o}) {
                        return '<a href="' + baseUrl + e + '"><div><i class="bx ' + t + ' me-2"></i><span class="align-middle">' + o + "</span></div></a>"
                    },
                ...
                templates: {
                    ...
                    suggestion: function ({src: e, name: t, subtitle: o, meta: s}) {
                        return '<a href="javascript:;"><div class="d-flex w-50"><img class="me-3" src="' + assetsPath + e + '" alt="' + t + '" height="32"><div class="w-75"><h6 class="mb-0">' + t + '</h6><small class="text-muted">' + o + '</small></div></div><small class="text-muted">' + s + "</small></a>"
                    },
                ...
                templates: {
                    ...
                    suggestion: function ({name: e, src: t, subtitle: o}) {
                        return '<a href="' + baseUrl + 'app/user/view/account"><div class="d-flex align-items-center"><img class="rounded-circle me-3" src="' + assetsPath + t + '" alt="' + e + '" height="32"><div class="user-info"><h6 class="mb-0">' + e + '</h6><small class="text-muted">' + o + "</small></div></div></a>"
                    },
                ...
                o.val(""), e.typeahead("val", ""), t.addClass("d-none"), s.addClass("fade").removeClass("show")
            })), o.on("keyup", (function () {
