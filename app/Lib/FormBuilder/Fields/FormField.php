...
use App\Lib\FormBuilder\Filters\Exception\FilterAlreadyBindedException;
use App\Lib\FormBuilder\Filters\FilterInterface;
use App\Lib\FormBuilder\Filters\FilterResolver;
use App\Lib\FormBuilder\Form;
use App\Lib\FormBuilder\FormHelper;
use App\Lib\FormBuilder\Rules;

/**
 * Class FormField
 *
 * @package App\Lib\FormBuilder\Fields
 */
abstract class FormField
{
    ...
    protected function prepareOptions(array $options = [])
    {
        ...
        $conditions = formConditionalFieldMap($conditions);
            if(is_array($conditions)){
                foreach ($conditions as $condition){

                  $this->setOption('conditions', $helper->prepareAttributes($condition));
     ...
     * @param  array $filters
     *
     * @return \App\Lib\FormBuilder\Fields\FormField
     */
