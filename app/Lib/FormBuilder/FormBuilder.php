...
use App\Lib\FormBuilder\Events\AfterFormCreation;
...
class FormBuilder
{
     ...
     *
     * @param string $formClass The name of the class that inherits \App\Lib\FormBuilder\Form.
     ...
     *
     * @param \App\Lib\FormBuilder\Form $instance
     * @param array $options
     * @param array $data
     * @return \App\Lib\FormBuilder\Form
     */
